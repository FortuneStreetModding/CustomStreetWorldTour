...
1. Download <a href="https://raw.githubusercontent.com/FortuneStreetModding/CustomStreetWorldTour/master/Setup/setup.bat" download>setup.bat</a> (Windows) or [setup.sh](Setup/setup.sh) (Unix) (on the page, right click 'Raw' and save linked content)
